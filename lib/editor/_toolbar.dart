...
class _EditorToolbarState extends State<EditorToolbar> {
  ...
  String _getTextTypeName(_TextType textType) {
    switch (textType) {
      case _TextType.header1:
        return S.of(context)!.labelHeader1;
      case _TextType.header2:
        return S.of(context)!.labelHeader2;
      case _TextType.header3:
        return S.of(context)!.labelHeader3;
      case _TextType.paragraph:
        return S.of(context)!.labelParagraph;
      case _TextType.blockquote:
        return S.of(context)!.labelBlockquote;
      case _TextType.orderedListItem:
        return S.of(context)!.labelOrderedListItem;
      case _TextType.unorderedListItem:
        return S.of(context)!.labelUnorderedListItem;
    }
  }
        ...
        child: Row(
          ...
          children: [
            ...
            if (_isConvertibleNode()) ...[
              Tooltip(
                message: S.of(context)!.labelTextBlockType,
            ...
            Center(
              child: IconButton(
                ...
                splashRadius: 16,
                tooltip: S.of(context)!.labelBold,
              ),
            ),
            Center(
              child: IconButton(
                ...
                splashRadius: 16,
                tooltip: S.of(context)!.labelItalics,
              ),
            ),
            Center(
              child: IconButton(
                ...
                splashRadius: 16,
                tooltip: S.of(context)!.labelStrikethrough,
              ),
            ),
            Center(
              child: IconButton(
                ...
                splashRadius: 16,
                tooltip: S.of(context)!.labelLink,
              ),
            ),
            ...
            if (_isTextAlignable()) ...[
              _buildVerticalDivider(),
              Tooltip(
                message: S.of(context)!.labelTextAlignment,
            ...
            Center(
              child: IconButton(
                ...
                splashRadius: 16,
                tooltip: S.of(context)!.labelMoreOptions,
              ),
            ),
          ],
        ),
